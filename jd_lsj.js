...
let inviterNick9 = '';
let inviterNick10 = '';
if ($.isNode() && process.env.inviterNick) {
    inviterNick = process.env.inviterNick;
}
if ($.isNode() && process.env.inviterNick2) {
    inviterNick2 = process.env.inviterNick2;
}
if ($.isNode() && process.env.inviterNick3) {
    inviterNick3 = process.env.inviterNick3;
}
if ($.isNode() && process.env.inviterNick4) {
    inviterNick4 = process.env.inviterNick4;
}
if ($.isNode() && process.env.inviterNick5) {
    inviterNick5 = process.env.inviterNick5;
}
if ($.isNode() && process.env.inviterNick6) {
    inviterNick6 = process.env.inviterNick6;
}
if ($.isNode() && process.env.inviterNick7) {
    inviterNick7 = process.env.inviterNick7;
}
if ($.isNode() && process.env.inviterNick8) {
    inviterNick8 = process.env.inviterNick8;
}
if ($.isNode() && process.env.inviterNick9) {
    inviterNick9 = process.env.inviterNick9;
}
if ($.isNode() && process.env.inviterNick10) {
