...
* 3.然后在`Repository name`处填写仓库名，最后点击最下方的`Begin import`即可

## 自动同步本仓库脚本教程：[点此查看](https://github.com/zero205/JD_tencent_scf/blob/main/backUp/reposync.md)  </br>

# 使用教程（觉得有用的可以点个star :blush:）  

* > 【青龙】拉库命令：`ql repo https://github.com/zero205/JD\_tencent\_scf.git "jd\_|jx\_"  "backUp" "^(jd|JD|JS)\[^\_]|USER|sendNotify|MovementFaker|ZooFaker\_Necklace"`  
